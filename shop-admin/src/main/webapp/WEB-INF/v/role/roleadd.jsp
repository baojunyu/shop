...
<div class="layui-container" style="margin-top: 5px">
    ...
    <form class="layui-form" action="${pageContext.request.contextPath}/role/add" method="post">
        <div class="layui-form-item">
            <label class="layui-form-label">角色名称</label>
            <div class="layui-input-block">
                <input type="text" name="roleName"  id="userAccount"   lay-verify="required" placeholder="请输入角色名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <%--<div class="layui-form-item">--%>
            <%--<label class="layui-form-label">创建用户ID</label>--%>
            <%--<div class="layui-input-block">--%>
                <%--<input type="password" name="createUserId" required lay-verify="required" placeholder="请输入创建用户ID" autocomplete="off" class="layui-input">--%>
            <%--</div>--%>
