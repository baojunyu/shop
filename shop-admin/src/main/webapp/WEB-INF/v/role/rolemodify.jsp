    ...
    <form class="layui-form" action="${pageContext.request.contextPath}/role/domodify" method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="roleUkid" value="${rolemodify.roleUkid}"  readonly="readonly" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="roleName" value="${rolemodify.roleName}" id="f2" lay-verify="required" autocomplete="off"
