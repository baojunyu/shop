...
<div class="layui-container" style="margin-top: 5px">
    ...
    <form class="layui-form" id="addform" lay-filter="addform" action="${pageContext.request.contextPath}/product/domodify" method="post">
        <div class="layui-form-item">
            <label class="layui-form-label">商品序号</label>
            <div class="layui-input-block">
                <input type="text" name="productId" value="${productmodify.productId}"  readonly="readonly" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="productName"  id="productName" value="${productmodify.productName}"  lay-verify="required" placeholder="商品名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">国条码</label>
            <div class="layui-input-block">
                <input type="text" name="barCode" id="barCode" value="${productmodify.barCode}" required lay-verify="required" placeholder="国条码" autocomplete="off" class="layui-input">
            </div>
                    ...
                    <select class="layui-input" lay-verify="required" name="brandId" id="brandId" >
                        <%-- <option value="">请选择</option>
                         ...
                         <option value="0">无效</option>--%>
                            <%--<option value="">${productmodify.brandId}</option>--%>
                    </select>
                </div>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <select class="layui-input" lay-verify="required" lay-filter="change" name="firstCategoryId" id="firstCategoryId">
                    <%--<option value="">${productmodify.firstCategoryId}</option>--%>
                </select>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="price" value="${productmodify.price}"id="price" lay-verify="required" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"    placeholder="商品重量（g）"  name="weight" value="${productmodify.weight}" id="weight" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">商品长度（毫米mm）</label>
            <div class="layui-input-block">
                <input type="text"    placeholder="商品长度（毫米mm）"  name="length" value="${productmodify.length}" id="length" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">商品高度（毫米mm）</label>
            <div class="layui-input-block">
                <input type="text"    placeholder="商品高度（毫米mm）"  name="height" value="${productmodify.height}" id="height" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">商品宽度（毫米mm）</label>
            <div class="layui-input-block">
                <input type="text"    placeholder="商品宽度（毫米mm）"  name="width" value="${productmodify.width}"  id="width" autocomplete="off" class="layui-input">
            </div>
        </div>
...
<script>
    ...
    $.get('${pageContext.request.contextPath}/brand',function (obj) {
        ...
        for(var i=0;i<obj.length;i++){
            if(obj[i].brandId==${productmodify.brandId}){
    ...
    $.get('${pageContext.request.contextPath}/categorys',function (obj) {
        ...
        var str="<option value=\"\">请选择</option>";
        for(var i=0;i<obj.length;i++){
            if(obj[i].categoryId==${productmodify.firstCategoryId}){
