...
<shiro:lacksPermission name="product:view">
    <h1>对不起！您没有该权限！！</h1>
    ...
    layui.use(['table','form','element'],function () {
        ...
        table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            var data = obj.data //获得当前行数据
                ,layEvent = obj.event; //获得 lay-event 对应的值       /product/images/"+data.productId;
            ...
            if(layEvent === 'showProductDes'){
                ...
                window.location.href="${pageContext.request.contextPath}/product/modifybyid?productId="+data.productId;

                <%--$.ajax({--%>
                    <%--url:'${pageContext.request.contextPath}/product/modifybyid',--%>
