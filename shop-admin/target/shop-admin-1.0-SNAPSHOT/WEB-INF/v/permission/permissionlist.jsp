...
<script type="text/javascript">
    ...
    layui.use(['table','form','element'],function () {
        ...
        tableIns=table.render({
            elem: '#demo'
            ,height: 312
            ,url: '${pageContext.request.contextPath}/permission/list' //数据接口
            ,title: '用户表'
            ,page: true //开启分页
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'type', title: '资源类型', width:120}
                ,{field: 'url', title: '访问url地址', width:120, sort: true}
                ,{field: 'percode', title: '权限代码字符串', width:150}
        ...
        table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'checkrole'){
                ...
                window.location.href="${pageContext.request.contextPath}/permission/modify?perId="+data.perId;
    ...
    function  delById(id,obj) {
        $.ajax({
            url:'${pageContext.request.contextPath}/permission/'+id,
            dataType:'json',
            type:'DELETE',
            cache:false,
            success:function (res) {
