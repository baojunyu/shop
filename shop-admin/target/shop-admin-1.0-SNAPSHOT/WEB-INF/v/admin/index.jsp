	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-right">
				<li class="layui-nav-item">
					<a href="javascript:;">
						<img src="${pageContext.request.contextPath}/${users.headimageurl}" class="layui-nav-img">
						${users.userName}
					</a>
					<dl class="layui-nav-child">
					<dd class="lef_menu" pid="8" url="${pageContext.request.contextPath}/v/user/headimage"><a href="#">修改头像</a></dd>
					<dd class="lef_menu" pid="7"  url="${pageContext.request.contextPath}/v/admin/changepass"><a href="#">修改密码</a></dd>
				</dl>
				</li>
